...
########################################################################################################################
    ...
    def monitoring(self):
        ...
        if hasattr(self, 'ad9363'):
            ...
            # Sampling
            self.DACRate_output.setText(str(float(self.ad9363._get_rxDownSampling()) / 1e6) + " Mhz")
            ...
            self.TxBW_output.setText(str(round(float(self.ad9363._get_rx0BW()), 2)) + " Mhz")
            # self.TxBW_output.setText(str(round(float(self.ad9363._get_rx1BW()), 2)) + " Mhz")
            self.RxBW_output.setText(str(round(float(self.ad9363._get_tx0BW()), 2)) + " Mhz")
