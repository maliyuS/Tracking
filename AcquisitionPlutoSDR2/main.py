...
class MyGUI(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # Création de l'instance SpectrumAnalyzer
        analyzer = SpectrumAnalyzer()
        self.gridLayout_8.addWidget(analyzer, 0, 0)
...
########################################################################################################################
    ...
    def instanciate_acquisition_variables(self):
